            ...
            <div className="student-Table">
                ...
                <div className="imgStudentInfo">
                    ...
                    <div className="myName">
                        ...
                        <div>Percentage Attendances: <labe style={{"background-color":Math.floor(was/dataStudent.length*100)>80?"green":"red","color":"white"}}> {Math.floor(was/dataStudent.length*100)}%</labe></div>
                    </div>
                </div>
                <br />
                <table cellspacing="0">
