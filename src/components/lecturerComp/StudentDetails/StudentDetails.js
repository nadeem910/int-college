            ...
            <div className="table-student">
                ...
                <div className="imgStudentInfo">
                    ...
                    <div className="myName">
                        ...
                        <div>Percentage Attendances: <labe style={{"background-color":Math.floor(was/data.length*100)>80?"green":"red","color":"white"}}> {Math.floor(was/data.length*100)}%</labe></div>
                    </div>
                </div>
                <table cellspacing="0">
